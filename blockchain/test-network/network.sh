...
function createOrgs() {
  ...
  if [ "$CRYPTO" == "cfssl" ]; then
    ...
    peer_cert peer peer0.org1.libBadge.com org1
    peer_cert admin Admin@org1.libBadge.com org1

    infoln "Creating Org2 Identities"
    #function_name cert-type   CN   org
    peer_cert peer peer0.org2.libBadge.com org2
    peer_cert admin Admin@org2.libBadge.com org2

    infoln "Creating Orderer Org Identities"
    #function_name cert-type   CN   
    orderer_cert orderer orderer.libBadge.com
    orderer_cert admin Admin@libBadge.com
...
function networkDown() {
  ...
  if [ "$MODE" != "restart" ]; then
    ...
    ${CONTAINER_CLI} volume rm docker_orderer.libBadge.com docker_peer0.org1.libBadge.com docker_peer0.org2.libBadge.com
