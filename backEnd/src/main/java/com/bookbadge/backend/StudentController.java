...
/*     
    ...
    public ResponseEntity<BadgeResponseDto> GetBadgeByBadgeNo(@PathVariable Integer badgeNo) {
        BadgeResponseDto badgeResponseDto = studentService.getBadge(badgeNo);
